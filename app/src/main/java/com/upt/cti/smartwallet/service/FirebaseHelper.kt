...
class FirebaseHelper {
    ...
    companion object {
        ...
        fun init() {
            ...
            val payment1 = Payment("2021-09-28 16:33:08", "Pizza Calzone", "food", 15.5)
            val payment2 = Payment("2021-10-10 08:23:09", "Paris", "travel", 20.5)
            val payment3 = Payment("2021-12-10 00:13:10", "AC/DC", "entertainment", 30.5)
